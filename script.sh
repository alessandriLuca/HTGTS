...
docker run --platform linux/amd64 -idv $tt:/sharedFolder --memory-reservation=10g -v /var/run/docker.sock:/var/run/docker.sock --cidfile  $tt/id.txt --privileged=true -p  8888:8888 repbioinfo/bcell1revision
